...
namespace seppzzz\SearchableDataObjects\Tasks;

use \Page;
use seppzzz\HTMLPurifier\Purifier;
use seppzzz\SearchableDataObjects\SearchableDataObject;
...
class PopulateSearch extends BuildTask
{
    ...
    private function clearTable()
    {
		...
		//SearchableDataObject::augmentDatabase();
		$newDB = (new SearchableDataObject)->augmentDatabase();
		
		// truncate the table
        DB::query("TRUNCATE TABLE SearchableDataObjects");

        // get searchable classes
        $implementors = ClassInfo::implementorsOf('seppzzz\SearchableDataObjects\Searchable');
    ...
    public function run($request)
    {
         ...
         * DataObjects
         */
        $searchables = ClassInfo::implementorsOf('seppzzz\SearchableDataObjects\Searchable');
